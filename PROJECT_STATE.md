...
- **TASK-AUTH-CONTRACT-001**：**In Progress（2026-08-11，用户已批准精确变更）**——新增 `INVALID_CREDENTIALS`（401）与 `INVALID_REQUEST`（422 Problem）并同步 SRS/OpenAPI/测试计划；规范提交完成后解除 AUTH 实现阻塞。
