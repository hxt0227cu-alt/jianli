...
- **TASK-DB-003**：**Waiting for Human Approval（2026-08-11）**——BOOKING-001 的 TC-APT-002 要求同事务写 NotificationEvent/AuditLog，但现有 schema 尚无两表；已产出最小迁移评审包，未写 migration、未执行数据库变更。
