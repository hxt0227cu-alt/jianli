...
def build_pages() -> dict[str, PageContentData]:
    ...
    resume_chunks = _chunk(
        ...
        [
            ...
            "我适合 AI 全栈、后端与平台工程岗位，尤其适合重视工程质量、技术深度、协作和可交接性"
            "的团队；选择公司时看重完整工程环境、成长空间和技术成长路径，长期向架构师发展。",
            "我最有成就感的一段工程经历，是建立一套可复现、可交接的确定性验证闭环：84/84 条"
            "工程用例全绿，三轮 Kafka 重平衡共 18,720 个事件零丢失，dbt 对 5.6 万行数据精确"
            "去重。我的核心贡献是把评测、故障注入、数据校验和结果留痕串成统一证据链，让结果"
            "能够被复跑、被核验，也能交给下一位工程师继续维护。",
