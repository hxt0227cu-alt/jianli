...
- 真实 PG/Redis 集成验证：二轮 **✅ 5 passed**；三轮 **✅ 用户 WSL 全套 14 passed in 14.84s（2026-08-13，pgvector/pg16 镜像）**——迁移 0001-0005（含 embedding 列）+ 会话 5 + 知识库 4；`verified_commit=851742a`（含三轮修复 `2acb6c4` 迁移 shape 断言、`0ac3dce` 删除禁检索断言解耦）
