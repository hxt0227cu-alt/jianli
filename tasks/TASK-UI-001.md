...
## 基线版本与基线 commit
- baseline：PRD 2.3.3 / 用例规约 1.7.2 / 领域模型 1.1.4 / SRS 1.0（approved）/ AI 治理 1.0.1（取自 `docs/baseline.yml`；SRS 已 approved 成为行为唯一源）
- 基线 commit：26ae8440c89ed680341ee1c6cecb036b27b224ec（SRS v1.0 正式 approved 锚点 / approval_commit；取代已作废的 173cf9b6）；领域模型 1.1.4（TASK-DM-002 批准锚点 f537296）
...
- 领域模型 v1.1.4：§5（状态机规范，颜色语义后端来源）/ §6（实体字段，表单字段来源）
